...
namespace DoctrineProxies\__CG__\Models\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Contatos extends \Models\Entities\Contatos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'id', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'nome', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'email', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'telefone', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'posicao', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'createdAt', '' . "\0" . 'Models\\Entities\\Contatos' . "\0" . 'updatedAt'];
        }
